...
//!
//! The driver must be initialised by passing an I2C  interface peripheral to the
...
//!
//! ```rust,no_run
//! use ssd1306-i2c::{prelude::*, Builder};
...
//! [the examples/ folder](https://github.com/ {{{ update this }}} /examples)
//!
